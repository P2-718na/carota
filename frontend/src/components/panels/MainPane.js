...
class MainPane extends Component {
    ...
    componentDidMount() {
        ...
        const options = {
            strings: [
                `welcome to carota!^1000 the current version is ${this.props.version}` + nl +
                "carota is a network analyzer,^300 it is able to read pcaps and extract connections", // 0
